...
from augment_data import create_split
...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_fc", type=list, default=[128, 10, 4]) #Always keep 4
    ...
    model = ConvNet(args.feature_map_sizes, args.filter_sizes, args.output_fc, args.num_classes, args.img_size, activation=torch.nn.LeakyReLU()).double()
